...
export function FAQSection() {
  return (
    ...
    >
      <h2 className="text-center font-unbounded text-3xl font-semibold md:text-4xl">
      ...
      <div className="w-full max-w-4xl space-y-8">
        {faqData.map((faq) => (
          <article 
            key={faq.id} 
            className="space-y-4 border-b border-neutral-800 pb-8 last:border-none last:pb-0"
          >
            <div className="flex items-start gap-6">
              ...
              <p className="font-unbounded text-lg leading-7 md:text-xl">
                {faq.question}
              </p>
            </div>
            <div className="ml-12">
